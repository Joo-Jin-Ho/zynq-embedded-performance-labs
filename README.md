...
Xilinx Zynq 기반 Zybo 보드를 활용하여 임베디드 시스템의 I/O 제어부터 메모리 및 연산 성능 최적화까지 단계적으로 실습했습니다. GPIO를 통해 Push Button, DIP Switch, LED를 제어하고 AXI 기반 하드웨어 구조와 Memory-Mapped I/O의 동작을 이해하였습니다. 이후 행렬 곱셈에 Loop Tiling을 적용하여 Cache 설정과 Tile Size에 따른 실행 시간 변화를 비교하였습니다. 이를 통해 하드웨어와 소프트웨어의 상호작용이 전체 시스템 성능에 미치는 영향을 실습 중심으로 학습하였습니다.
...
<img width="410" height="250" alt="image" src="https://github.com/user-attachments/assets/b1f1dcd3-d45f-4c8d-a731-370ea1738f35" />
<img width="410" height="250" alt="image" src="https://github.com/user-attachments/assets/b6db527a-71d8-4ad2-937a-0930eeebf96c" />
